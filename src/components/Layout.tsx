...
export const menuItems = [
  ...
  { name: "Status Reports", path: "/blog/", exact: false, icon: "newspaper" },
  { name: "Documents", path: "/documents/", exact: false, icon: "file pdf" },
  { name: "Screenshots", path: "/screenshots/", exact: false, icon: "image" },
];
